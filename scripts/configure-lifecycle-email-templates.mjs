...
for (const name of ['yahtzee-first-game', 'yahtzee-download-app', 'yahtzee-inactive-player']) {
...
console.log('Lifecycle templates now contain explicit consent wording and one-click unsubscribe links.');
